...
class Featured_Authors extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 
			...
			'description' => 'Feature your blog\'s authors in your blog\'s sidebar.',
		...
		{
			exit ("Featured Authors requires Wordpress version 3.3.2 or later. Please update Wordpress. :)");
		}
	...
	function widget( $args, $instance ) {
		...
		if(!empty($instance['authors'])):
			foreach($instance['authors'] as $author){
				...
				echo '</div><div class="fix"></div></div>';
